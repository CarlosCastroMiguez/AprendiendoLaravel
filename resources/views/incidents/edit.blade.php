    ...
    <div class="card-body">
        ...
        <form action="" method="POST">
            ...
            <div class="form-group">
                ...
                <input name="title" name="title" class="form-control" value="{{ old('title' , $incident->title) }}" required></input>
            </div>
            <div class="form-group">
                <label for="description">Descripción</label>
                <textarea name="description" class="form-control" required>{{ old('description', $incident->description) }}</textarea>
            </div>
            <div class="form-group">
